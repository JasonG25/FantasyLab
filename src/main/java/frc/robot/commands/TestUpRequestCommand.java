...
public class TestUpRequestCommand extends Command {
   ...
   */
  public TestUpRequestCommand(TestSubsystem subsystem) {
  ...
  public boolean isFinished() {
    return m_subsystem.isAtPosition(TestConstants.UpPosition);
  }
}
